...
def main():
    ...
    parser.add_option("-l", "--latex",
                      ...
                      help="""Print in convenient format for insertion in latex
                              tabular environments""")
    parser.add_option("-p", "--precision", "--precision_length",
                      action="store", type="int", dest="precision_length",
                      default=3, help="""Number of decimal places to return
                                         (length in Angstroms)""")
    parser.add_option("-a", "--precision_angle",
                      action="store", type="int", dest="precision_angle",
                      default=2, help="""Number of decimal places to return
                                         (angle in degrees)""")
    ...
    if options.latex_format:
        print('{0:6.{6}f}&{1:6.{6}f}&{2:6.{6}f}&{3:6.{7}f}&'
              '{4:6.{7}f}&{5:6.{7}f}'.format(a, b, c, alpha, beta, gamma,
        ...
        print('{0:.{6}f} {1:.{6}f} {2:.{6}f} {3:.{7}f} {4:.{7}f} '
